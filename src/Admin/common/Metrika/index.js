...
// TODO: Убранные события (из старого функционала)
/*
 *  Аэропанорама (переход в сектор)
 * @type {string}
...
const panoramaEvents = new EventEmitter();

metrikaEvents.setMaxListeners(24);
panoramaEvents.setMaxListeners(10);
...
export { metrikaEvents as default, panoramaEvents };
