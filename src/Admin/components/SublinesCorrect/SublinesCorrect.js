...
import {
    ...
    STREET_TILE, SATELLITE_TILE, ACCESS_TOKEN_LMAPS,
} from "./constants";
import Imglayers from "../Map/_Deprecated/Layers";
...
import SublinesContentView from "../../views/Lines/LineContentView/Tabs/Panorama/SublineContentView";
                ...
                `}>
                    ...
                    <Map
                        ...
                        <LayersControl position="topleft">
                            ...
                            <BaseLayer
                                name="Спутник">
                                <TileLayer url={`${SATELLITE_TILE}${ACCESS_TOKEN_LMAPS}`} />
                            </BaseLayer>
                        </LayersControl>
                        {
                            panMarkers.length > 0 && (
